...
type User struct {
	...
	Mobilephone         null.String `boil:"mobilephone" json:"mobilephone,omitempty" toml:"mobilephone" yaml:"mobilephone,omitempty"`
	MobilephoneVerified bool        `boil:"mobilephone_verified" json:"mobilephone_verified" toml:"mobilephone_verified" yaml:"mobilephone_verified"`
	...
	BirthPlace          null.String `boil:"birth_place" json:"birth_place,omitempty" toml:"birth_place" yaml:"birth_place,omitempty"`
	DateOfBirth         null.Time   `boil:"date_of_birth" json:"date_of_birth,omitempty" toml:"date_of_birth" yaml:"date_of_birth,omitempty"`
	RegisterProvider    null.String `boil:"register_provider" json:"register_provider,omitempty" toml:"register_provider" yaml:"register_provider,omitempty"`
	...
	Profession          null.String `boil:"profession" json:"profession,omitempty" toml:"profession" yaml:"profession,omitempty"`
	MobilephonePrefix   null.String `boil:"mobilephone_prefix" json:"mobilephone_prefix,omitempty" toml:"mobilephone_prefix" yaml:"mobilephone_prefix,omitempty"`
	...
	MustUpdatePassword  bool        `boil:"must_update_password" json:"must_update_password" toml:"must_update_password" yaml:"must_update_password"`
...
var UserColumns = struct {
	...
	IsAdmin             string
	IsStaff             string
	MustUpdatePassword  string
}{
	ID:                  "id",
	Email:               "email",
	EmailVerified:       "email_verified",
	Mobilephone:         "mobilephone",
	MobilephoneVerified: "mobilephone_verified",
	Active:              "active",
	...
	MobilephonePrefix:   "mobilephone_prefix",
	IsAdmin:             "is_admin",
	IsStaff:             "is_staff",
...
var UserTableColumns = struct {
	...
	MobilephoneVerified: "users.mobilephone_verified",
	Active:              "users.active",
	FirstName:           "users.first_name",
	LastName:            "users.last_name",
	Gender:              "users.gender",
	BirthPlace:          "users.birth_place",
	DateOfBirth:         "users.date_of_birth",
	RegisterProvider:    "users.register_provider",
	Photo:               "users.photo",
	Deleted:             "users.deleted",
	CreatedAt:           "users.created_at",
	UpdatedAt:           "users.updated_at",
	Profession:          "users.profession",
	MobilephonePrefix:   "users.mobilephone_prefix",
	IsAdmin:             "users.is_admin",
	IsStaff:             "users.is_staff",
	MustUpdatePassword:  "users.must_update_password",
}
...
var UserWhere = struct {
	...
	MobilephoneVerified whereHelperbool
	Active              whereHelperbool
	FirstName           whereHelpernull_String
	LastName            whereHelpernull_String
	Gender              whereHelpernull_String
	BirthPlace          whereHelpernull_String
	DateOfBirth         whereHelpernull_Time
	RegisterProvider    whereHelpernull_String
	Photo               whereHelpernull_String
	Deleted             whereHelperbool
	CreatedAt           whereHelpertime_Time
	UpdatedAt           whereHelpertime_Time
	Profession          whereHelpernull_String
	MobilephonePrefix   whereHelpernull_String
	IsAdmin             whereHelperbool
	IsStaff             whereHelperbool
	MustUpdatePassword  whereHelperbool
}{
	ID:                  whereHelperstring{field: "\"users\".\"id\""},
	Email:               whereHelpernull_String{field: "\"users\".\"email\""},
	EmailVerified:       whereHelperbool{field: "\"users\".\"email_verified\""},
	Mobilephone:         whereHelpernull_String{field: "\"users\".\"mobilephone\""},
	MobilephoneVerified: whereHelperbool{field: "\"users\".\"mobilephone_verified\""},
	...
	BirthPlace:          whereHelpernull_String{field: "\"users\".\"birth_place\""},
	DateOfBirth:         whereHelpernull_Time{field: "\"users\".\"date_of_birth\""},
	RegisterProvider:    whereHelpernull_String{field: "\"users\".\"register_provider\""},
	Photo:               whereHelpernull_String{field: "\"users\".\"photo\""},
	Deleted:             whereHelperbool{field: "\"users\".\"deleted\""},
	CreatedAt:           whereHelpertime_Time{field: "\"users\".\"created_at\""},
	UpdatedAt:           whereHelpertime_Time{field: "\"users\".\"updated_at\""},
	Profession:          whereHelpernull_String{field: "\"users\".\"profession\""},
	MobilephonePrefix:   whereHelpernull_String{field: "\"users\".\"mobilephone_prefix\""},
	IsAdmin:             whereHelperbool{field: "\"users\".\"is_admin\""},
	IsStaff:             whereHelperbool{field: "\"users\".\"is_staff\""},
	MustUpdatePassword:  whereHelperbool{field: "\"users\".\"must_update_password\""},
}
...
var (
	userAllColumns            = []string{"id", "email", "email_verified", "mobilephone", "mobilephone_verified", "active", "first_name", "last_name", "gender", "birth_place", "date_of_birth", "register_provider", "photo", "deleted", "created_at", "updated_at", "profession", "mobilephone_prefix", "is_admin", "is_staff", "must_update_password"}
	userColumnsWithoutDefault = []string{"id", "email_verified", "mobilephone_verified", "active", "deleted", "created_at", "updated_at", "is_admin", "is_staff", "must_update_password"}
	userColumnsWithDefault    = []string{"email", "mobilephone", "first_name", "last_name", "gender", "birth_place", "date_of_birth", "register_provider", "photo", "profession", "mobilephone_prefix"}
