...
func testAuthGroupPermissionToOneAuthPermissionUsingPermission(t *testing.T) {
	...
	AddAuthPermissionHook(boil.AfterSelectHook, func(ctx context.Context, e boil.ContextExecutor, o *AuthPermission) error {
...
func testAuthGroupPermissionToOneAuthGroupUsingGroup(t *testing.T) {
	...
	ranAfterSelectHook := false
	AddAuthGroupHook(boil.AfterSelectHook, func(ctx context.Context, e boil.ContextExecutor, o *AuthGroup) error {
		ranAfterSelectHook = true
		return nil
	})
