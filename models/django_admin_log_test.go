...
func testDjangoAdminLogToOneDjangoContentTypeUsingContentType(t *testing.T) {
	...
	AddDjangoContentTypeHook(boil.AfterSelectHook, func(ctx context.Context, e boil.ContextExecutor, o *DjangoContentType) error {
...
func testDjangoAdminLogToOneAuthUserUsingUser(t *testing.T) {
	...
	ranAfterSelectHook := false
	AddAuthUserHook(boil.AfterSelectHook, func(ctx context.Context, e boil.ContextExecutor, o *AuthUser) error {
		ranAfterSelectHook = true
		return nil
	})
