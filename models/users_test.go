...
var (
	userDBTypes = map[string]string{`ID`: `uuid`, `Email`: `character varying`, `EmailVerified`: `boolean`, `Mobilephone`: `character varying`, `MobilephoneVerified`: `boolean`, `Active`: `boolean`, `FirstName`: `character varying`, `LastName`: `character varying`, `Gender`: `character varying`, `BirthPlace`: `character varying`, `DateOfBirth`: `date`, `RegisterProvider`: `character varying`, `Photo`: `character varying`, `Deleted`: `boolean`, `CreatedAt`: `timestamp with time zone`, `UpdatedAt`: `timestamp with time zone`, `Profession`: `character varying`, `MobilephonePrefix`: `character varying`, `IsAdmin`: `boolean`, `IsStaff`: `boolean`, `MustUpdatePassword`: `boolean`}
	_           = bytes.MinRead
)
